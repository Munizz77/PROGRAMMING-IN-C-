...
int main() {
  ...
  srand(time(NULL));
	...
	printf("Imprimindo M preenchido com valores aleatório %d a %d:\n", minvalor, maxvalor - 1);
	imprimirM(tamanhoM, M);

	substituirValoresPares(tamanhoM, M);

	printf("\n\nImprimindo Mes com valores pares substituídos por 0:\n");
	imprimirM(tamanhoM, M);
	substituirValoresImpares(tamanhoM, M);
	printf("\n\nImprimindo Mes com valores ímpares substituídos por 1:\n");
	imprimirM(tamanhoM, M);
